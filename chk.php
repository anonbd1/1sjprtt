...
curl_setopt($ch, CURLOPT_URL, 'https://tools.rsoblog.com/g3.php');
curl_setopt($curl, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'authority: tools.rsoblog.com',
'method: GET',
'scheme: https',
'accept: */*',
...
elseif
(strpos($result1,  'Entered RSO Token Expired.')) {
