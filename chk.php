...
curl_setopt($ch, CURLOPT_POSTFIELDS,'{"pageId":3148,"paymentMethod":{"paymentType":1,"token":"'.$token.'"},"amountType":0,"anonymityID":0,"scheduledGivingStartDate":"2022-03-23","amount":3,"messageToCharity":"","suggestedAskAmount":3,"fundID":'.$id.',"donorInfo":{"firstName":"'.$name.'","lastName":"'.$last.'
