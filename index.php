...
<head>
<title>Card Checker - Gate : 3</title>
...
<meta name="keywords" content="cc checker,ccgen,rso blog,ros checker,credit card,cc,credit card checker,credit card generator">
<meta name="author" content="RSO Blog" />
...
<link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/anonbd1/authu/main/style.cs">
</head>
<body>
...
<h5>RSO Checker - Gate 3 <label class="badge badge-info">#Beast</label></h5>
</div>
...
<br />
<center><button class="btn waves-effect waves-light btn-grd-success btn-block" id="testar" onclick="enviar()">Start</button>
...
<div class="card sale-card">
<div class="card-header">
<h5><label class="label label-warning">UNKNOWN</label></h5>
</div>
<div class="card-block">
...
<center>&copy; 2022 - <a href="https://tools.receivefreesms.co.uk" target="_blank">RSO Tools</a>
<br>
Powered By : <a href="https://blog.receivefreesms.co.uk" target="_blank">RSO Blog</a>
</center>
<br>
